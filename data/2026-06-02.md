...
### [6] [Improving IoT Intrusion Detection Through SMOTE-Based Oversampling and Extended Multi-Model Evaluation on Side-Channel Power Data](https://arxiv.org/abs/2606.00161)
...
### [7] [Inferring Routing-Layer Defense Mechanisms from Observable Behavior in OLSR-Based MANETs](https://arxiv.org/abs/2606.00184)
...
### [10] [Bit-Exact AI Inference Verification Without Performance Tradeoffs](https://arxiv.org/abs/2606.00279)
*Naci Cankaya*
...
### [11] [Beyond Edge Coverage: Per-Task Data-Flow Extraction at Kernel Function Boundaries via LLVM](https://arxiv.org/abs/2606.00455)
*Yunseong Kim*
...
### [20] [A Lightweight Hybrid MLP-Based Framework for Real-Time Phishing URL Detection Using Structural URL Features](https://arxiv.org/abs/2606.00889)
...
### [21] [Framework for Discovering GPS Spoofing Attacks in Drone Swarms](https://arxiv.org/abs/2606.00904)
...
### [22] [One (Thread) Can Keep a (PRNG) Secret, but not Two](https://arxiv.org/abs/2606.00918)
...
### [23] [Benchmarking Security Risk Detection and Verification in Open Agentic Skill Ecosystems](https://arxiv.org/abs/2606.00925)
...
### [24] [SS-ZKR: Spatial-Semantic Zero-Knowledge Routing for Privacy-Preserving Multi-Agent Collaboration](https://arxiv.org/abs/2606.00962)
*Hassan Touheed*
...
### [25] [AMP: A Vendor-Neutral Wire Format for Agent Memory Operations](https://arxiv.org/abs/2606.01138)
...
### [26] [BraveGuard: From Open-World Threats to Safer Computer-Use Agents](https://arxiv.org/abs/2606.01166)
...
### [27] [Schema-Agnostic Knowledge Graph Construction via Hybrid Ontology Discovery for Cyber Threat Intelligence](https://arxiv.org/abs/2606.01208)
...
### [28] [GPU Acceleration of Learning With Errors KEMs Using OpenACC for Post-Quantum Cryptography](https://arxiv.org/abs/2606.01211)
...
### [29] [Privacy-Preserving Smart Surveillance with Cross-Dataset Violence Detection and Decentralized Evidence Governance](https://arxiv.org/abs/2606.01225)
...
### [30] [Needles at Scale: LLM-Assisted Target Selection for Windows Vulnerability Research](https://arxiv.org/abs/2606.01364)
*Michael J. Bommarito*
...
### [31] [Formal Verification of Secure Encrypted Virtualization](https://arxiv.org/abs/2606.01381)
...
### [32] [Differentially Private Datastore Generation for Retrieval-Augmented Inference](https://arxiv.org/abs/2606.01413)
...
### [33] [On the Evaluation of Spiking Neural Network Configurations for Network Intrusion Detection](https://arxiv.org/abs/2606.01442)
...
### [34] [NetVAD: Foundation-Model Representation Learning for Identifier-Free Unsupervised Intrusion Detection](https://arxiv.org/abs/2606.01452)
...
### [35] [ClawHub Security Signals: When VirusTotal, Static Analysis, and SkillSpector Disagree](https://arxiv.org/abs/2606.01494)
...
### [36] [Agent Operating Systems (AOS): Integrating Agentic Control Planes into, and Beyond, Traditional Operating Systems](https://arxiv.org/abs/2606.01508)
...
### [37] [Defenses & Enablers For Skill Injection Attacks on Terminal Based Agents](https://arxiv.org/abs/2606.01567)
...
### [38] [CoreUnlearn: Rethinking Concept Unlearning through Disentangled Component-Level Erasure in Text-guided Diffusion Models](https://arxiv.org/abs/2606.01658)
...
### [39] [IstGPT: LLM-based Anomaly Detection for Spatial-Temporal Graph in Industrial Systems](https://arxiv.org/abs/2606.01691)
...
### [40] [SECUREVENT: Hybrid AI/ML Security Monitoring for Distributed Event-Based Systems](https://arxiv.org/abs/2606.01741)
*Eric Liang*
...
### [41] [Tridirectional Discriminating-Power Formal Verification of Smart Contract Reentrancy Defense Against Production-Deployed Solidity Source](https://arxiv.org/abs/2606.01794)
*Ray Iskander*
...
### [42] [Benign Inputs, Harmful Outputs: Cross-Modal Jailbreaking via Distributed Semantic Recomposition](https://arxiv.org/abs/2606.01837)
...
### [43] [Implementation and Optimization of HQC Decoding on NPU-Integrated Devices](https://arxiv.org/abs/2606.01968)
...
### [44] [PeAR: A Static Binary Rewriting Framework for Binary-Only Fuzzing](https://arxiv.org/abs/2606.02126)
...
### [45] [The Unicity Execution Layer](https://arxiv.org/abs/2606.02181)
...
### [46] [Unicity: Predicates and Atomic Swaps](https://arxiv.org/abs/2606.02192)
*Ahto Buldas,Dirk Draheim,Mike Gault,Risto Laanoja,Vladimir Rogojin,Ahto Truu*
...
### [47] [PyFEX: Uncovering Evasive Python-based Threats via Resilient and Exhaustive Path Exploration](https://arxiv.org/abs/2606.02196)
...
### [48] [AgentRedBench: Dynamic Redteaming and Integration-Aware Defense for LLM Agents over SaaS Integrations](https://arxiv.org/abs/2606.02240)
...
### [49] [SeClaw: Spec-Driven Security Task Synthesis for Evaluating Autonomous Agents](https://arxiv.org/abs/2606.02302)
...
### [50] [I-(OT)^2: A Client-optimal Oblivious Transfer Protocol for IoT Devices](https://arxiv.org/abs/2606.02344)
...
### [51] [Ghost Tool Calls: Issue-Time Privacy for Speculative Agent Tools](https://arxiv.org/abs/2606.02483)
