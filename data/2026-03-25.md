...
### [16] [Agent-Sentry: Bounding LLM Agents via Execution Provenance](https://arxiv.org/abs/2603.22868)
...
### [17] [SoK: The Attack Surface of Agentic AI -- Tools, and Autonomy](https://arxiv.org/abs/2603.22928)
...
### [18] [Privacy-Preserving EHR Data Transformation via Geometric Operators: A Human-AI Co-Design Technical Report](https://arxiv.org/abs/2603.22954)
...
### [19] [Beyond Theoretical Bounds: Empirical Privacy Loss Calibration for Text Rewriting Under Local Differential Privacy](https://arxiv.org/abs/2603.22968)
...
### [20] [How Far Should We Need to Go : Evaluate Provenance-based Intrusion Detection Systems in Industrial Scenarios](https://arxiv.org/abs/2603.22982)
...
### [21] [A Critical Review on the Effectiveness and Privacy Threats of Membership Inference Attacks](https://arxiv.org/abs/2603.22987)
...
### [22] [Multi-User Multi-Key Image Steganography with Key Isolation](https://arxiv.org/abs/2603.23005)
...
### [23] [AgentRAE: Remote Action Execution through Notification-based Visual Backdoors against Screenshots-based Mobile GUI Agents](https://arxiv.org/abs/2603.23007)
...
### [24] [RTS-ABAC: Real-Time Server-Aided Attribute-Based Authorization & Access Control for Substation Automation Systems](https://arxiv.org/abs/2603.23012)
...
### [25] [Mind Your HEARTBEAT! Claw Background Execution Inherently Enables Silent Memory Pollution](https://arxiv.org/abs/2603.23064)
...
### [26] [TRAP: Hijacking VLA CoT-Reasoning via Adversarial Patches](https://arxiv.org/abs/2603.23117)
...
### [27] [Robust Safety Monitoring of Language Models via Activation Watermarking](https://arxiv.org/abs/2603.23171)
...
### [28] [Privacy-Aware Smart Cameras: View Coverage via Socially Responsible Coordination](https://arxiv.org/abs/2603.23197)
...
### [29] [PRETTINESS -- Privacy pResErving aTTrIbute maNagEment SyStem](https://arxiv.org/abs/2603.23221)
...
### [30] [Gyokuro: Source-assisted Private Membership Testing using Trusted Execution Environments](https://arxiv.org/abs/2603.23226)
...
### [31] [The Power of Power Codes: New Classes of Easy Instances for the Linear Equivalence Problem](https://arxiv.org/abs/2603.23230)
...
### [32] [On the Vulnerability of FHE Computation to Silent Data Corruption](https://arxiv.org/abs/2603.23253)
...
### [33] [Not All Tokens Are Created Equal: Query-Efficient Jailbreak Fuzzing for LLMs](https://arxiv.org/abs/2603.23269)
...
### [34] [Security Barriers to Trustworthy AI-Driven Cyber Threat Intelligence in Finance: Evidence from Practitioners](https://arxiv.org/abs/2603.23304)
...
### [35] [Canonical Byte-String Encoding for Finite-Ring Cryptosystems](https://arxiv.org/abs/2603.23364)
...
### [36] [An Experimental Study of Machine Learning-Based Intrusion Detection for OPC UA over Industrial Private 5G Networks](https://arxiv.org/abs/2603.23416)
...
### [37] [Targeted Adversarial Traffic Generation : Black-box Approach to Evade Intrusion Detection Systems in IoT Networks](https://arxiv.org/abs/2603.23438)
...
### [38] [CSTS: A Canonical Security Telemetry Substrate for AI-Native Cyber Detection](https://arxiv.org/abs/2603.23459)
*Abdul Rahman*
