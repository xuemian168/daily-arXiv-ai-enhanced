...
### [9] [Towards Optimal Agentic Architectures for Offensive Security Tasks](https://arxiv.org/abs/2604.18718)
...
### [10] [Blockchain-Driven AI-Enhanced Post-Quantum Multivariate Identity-based Signature and Privacy-Preserving Data Aggregation Scheme for Fog-enabled Flying Ad-Hoc Networks](https://arxiv.org/abs/2604.18819)
...
### [11] [Temporal UI State Inconsistency in Desktop GUI Agents: Formalizing and Defending Against TOCTOU Attacks on Computer-Use Agents](https://arxiv.org/abs/2604.18860)
*Wenpeng Xu*
...
### [12] [SAGE: Signal-Amplified Guided Embeddings for LLM-based Vulnerability Detection](https://arxiv.org/abs/2604.19031)
...
### [13] [Refute-or-Promote: An Adversarial Stage-Gated Multi-Agent Review Methodology for High-Precision LLM-Assisted Defect Discovery](https://arxiv.org/abs/2604.19049)
*Abhinav Agarwal*
...
### [14] [CHRONOS: A Hardware-Assisted Phase-Decoupled Framework for Secure Federated Learning in IoT](https://arxiv.org/abs/2604.19053)
*Hung Dang*
...
### [15] [ProjLens: Unveiling the Role of Projectors in Multimodal Model Safety](https://arxiv.org/abs/2604.19083)
...
### [16] [Dual-Guard: Dual-Channel Latent Watermarking for Provenance and Tamper Localization in Diffusion Images](https://arxiv.org/abs/2604.19090)
...
### [17] [DP-FlogTinyLLM: Differentially private federated log anomaly detection using Tiny LLMs](https://arxiv.org/abs/2604.19118)
...
### [18] [Sherpa.ai Privacy-Preserving Multi-Party Entity Alignment without Intersection Disclosure for Noisy Identifiers](https://arxiv.org/abs/2604.19219)
...
### [19] [Secure Storage and Privacy-Preserving Scanpath Comparison via Garbled Circuits in Eye Tracking](https://arxiv.org/abs/2604.19422)
...
### [20] [Malicious ML Model Detection by Learning Dynamic Behaviors](https://arxiv.org/abs/2604.19438)
...
### [21] [Involuntary In-Context Learning: Exploiting Few-Shot Pattern Completion to Bypass Safety Alignment in GPT-5.4](https://arxiv.org/abs/2604.19461)
...
### [22] [API Security Based on Automatic OpenAPI Mapping](https://arxiv.org/abs/2604.19471)
...
### [23] [EvoPatch-IoT: Evolution-Aware Cross-Architecture Vulnerability Retrieval and Patch-State Profiling for BusyBox-Based IoT Firmware](https://arxiv.org/abs/2604.19496)
...
### [24] [Evaluating LLM-Generated Obfuscated XSS Payloads for Machine Learning-Based Detection](https://arxiv.org/abs/2604.19526)
...
### [25] [Cyber Defense Benchmark: Agentic Threat Hunting Evaluation for LLMs in SecOps](https://arxiv.org/abs/2604.19533)
...
### [26] [Adding Compilation Metadata To Binaries To Make Disassembly Decidable](https://arxiv.org/abs/2604.19628)
...
### [27] [An AI Agent Execution Environment to Safeguard User Data](https://arxiv.org/abs/2604.19657)
...
### [28] ["We are currently clean on OPSEC": Why JD Can't Encrypt](https://arxiv.org/abs/2604.19711)
