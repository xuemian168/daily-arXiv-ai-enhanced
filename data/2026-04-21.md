...
### [4] [Anumati: Proof of Adherence as a Formal Consent Model for Autonomous Agent Protocols](https://arxiv.org/abs/2604.16524)
...
### [5] [Public and private blockchain for decentralized digital building twins and building automation system](https://arxiv.org/abs/2604.16534)
...
### [6] [TWGuard: A Case Study of LLM Safety Guardrails for Localized Linguistic Contexts](https://arxiv.org/abs/2604.16542)
...
### [7] [A Survey on the Security of Long-Term Memory in LLM Agents: Toward Mnemonic Sovereignty](https://arxiv.org/abs/2604.16548)
...
### [8] [Polynomial Multiproofs for Scalable Data Availability Sampling in Blockchain Light Clients](https://arxiv.org/abs/2604.16559)
...
### [9] [SafeLM: Unified Privacy-Aware Optimization for Trustworthy Federated Large Language Models](https://arxiv.org/abs/2604.16606)
...
### [10] [Stringology Based Cryptology](https://arxiv.org/abs/2604.16669)
*Victor Kebande*
...
### [11] [Surgical Repair of Insecure Code Generation in LLMs](https://arxiv.org/abs/2604.16697)
...
### [12] [Glitch in the Sky: Exploiting Voltage Fault Injection in UAV Flight Controllers](https://arxiv.org/abs/2604.16699)
...
### [13] [Privacy-Aware Machine Unlearning with SISA for Reinforcement Learning-Based Ransomware Detection](https://arxiv.org/abs/2604.16760)
...
### [14] [CapSeal: Capability-Sealed Secret Mediation for Secure Agent Execution](https://arxiv.org/abs/2604.16762)
...
### [15] [SafeDream: Safety World Model for Proactive Early Jailbreak Detection](https://arxiv.org/abs/2604.16824)
...
### [16] [ParikkhaChain: Blockchain-Based Result Processing and Privacy-Preserving Academic Record Management for the Complete Examination Lifecycle](https://arxiv.org/abs/2604.16827)
...
### [17] [DALC-CT: Dynamic Analysis of Low-Level Code Traces for Constant-Time Verification](https://arxiv.org/abs/2604.16832)
...
### [18] [Towards Deep Encrypted Training: Low-Latency, Memory-Efficient, and High-Throughput Inference for Privacy-Preserving Neural Networks](https://arxiv.org/abs/2604.16834)
...
### [19] [Visual Inception: Compromising Long-term Planning in Agentic Recommenders via Multimodal Memory Poisoning](https://arxiv.org/abs/2604.16966)
*Jiachen Qian*
...
### [20] [From Public-Key Linting to Operational Post-Quantum X.509 Assurance for ML-KEM and ML-DSA: Registry-Driven Policy, Mutation-Based Evaluation, and Import Validation](https://arxiv.org/abs/2604.17003)
...
### [21] [False Security Confidence in Benign LLM Code Generation](https://arxiv.org/abs/2604.17014)
*Xiaolei Ren*
...
### [22] [HarmChip: Evaluating Hardware Security Centric LLM Safety via Jailbreak Benchmarking](https://arxiv.org/abs/2604.17093)
...
### [23] [CASCADE: A Cascaded Hybrid Defense Architecture for Prompt Injection Detection in MCP-Based Systems](https://arxiv.org/abs/2604.17125)
...
### [24] [Systematic Capability Benchmarking of Frontier Large Language Models for Offensive Cyber Tasks](https://arxiv.org/abs/2604.17159)
...
### [25] [Decentralised Trust and Security Mechanisms for IoT Networks at the Edge: A Comprehensive Review](https://arxiv.org/abs/2604.17179)
...
### [26] [Breaking Euston: Recovering Private Inputs from Secure Inference by Exploiting Subspace Leakage](https://arxiv.org/abs/2604.17238)
...
### [27] [Bit-Flip Vulnerability of Shared KV-Cache Blocks in LLM Serving Systems](https://arxiv.org/abs/2604.17249)
...
### [28] [A Unified Compliance Aggregator Framework for Automated Multi-Tool Security Assessment of Linux Systems](https://arxiv.org/abs/2604.17256)
...
### [29] [Privatar: Scalable Privacy-preserving Multi-user VR via Secure Offloading](https://arxiv.org/abs/2604.17476)
...
### [30] [Explainable Attention-Based LSTM Framework for Early Detection of AI-Assisted Ransomware via File System Behavioral Analysis](https://arxiv.org/abs/2604.17522)
...
### [31] [SoK: Reshaping Research on Network Intrusion Detection Systems](https://arxiv.org/abs/2604.17556)
*Giovanni Apruzzese*
...
### [32] [Terminal Wrench: A Dataset of 331 Reward-Hackable Environments and 3,632 Exploit Trajectories](https://arxiv.org/abs/2604.17596)
...
### [33] [Original Sin of npm: A Study on Vulnerability Propagation in JavaScript Dependency Networks](https://arxiv.org/abs/2604.17668)
...
### [34] [SDLLMFuzz: Dynamic-static LLM-assisted greybox fuzzing for structured input programs](https://arxiv.org/abs/2604.17750)
...
### [35] [A Quasi-Experimental Developer Study of Security Training in LLM-Assisted Web Application Development](https://arxiv.org/abs/2604.17763)
...
### [36] [SoK: Analysis of Privacy Risks and Mitigation in Online Propaganda Detection through the PROMPT Framework](https://arxiv.org/abs/2604.17788)
...
### [37] [Understanding Secret Leakage Risks in Code LLMs: A Tokenization Perspective](https://arxiv.org/abs/2604.17814)
...
### [38] [Privacy-Preserving Product-Quantized Approximate Nearest Neighbor Search Framework for Large-scale Datasets via A Hybrid of Fully Homomorphic Encryption and Trusted Execution Environment](https://arxiv.org/abs/2604.17816)
...
### [39] [TitanCA: Lessons from Orchestrating LLM Agents to Discover 100+ CVEs](https://arxiv.org/abs/2604.17860)
...
### [40] [RAVEN: Retrieval-Augmented Vulnerability Exploration Network for Memory Corruption Analysis in User Code and Binary Programs](https://arxiv.org/abs/2604.17948)
...
### [41] [ExAI5G: A Logic-Based Explainable AI Framework for Intrusion Detection in 5G Networks](https://arxiv.org/abs/2604.18052)
...
### [42] [Enhancing Anomaly-Based Intrusion Detection Systems with Process Mining](https://arxiv.org/abs/2604.18066)
...
### [43] [Dynamic Risk Assessment by Bayesian Attack Graphs and Process Mining](https://arxiv.org/abs/2604.18080)
...
### [44] [Audit-or-Cast: Enforcing Honest Elections with Privacy-Preserving Public Verification](https://arxiv.org/abs/2604.18163)
...
### [45] [Committed SAE-Feature Traces for Audited-Session Substitution Detection in Hosted LLMs](https://arxiv.org/abs/2604.18179)
*Ziyang Liu*
...
### [46] [AgenTEE: Confidential LLM Agent Execution on Edge Devices](https://arxiv.org/abs/2604.18231)
...
### [47] [Beyond Pattern Matching: Seven Cross-Domain Techniques for Prompt Injection Detection](https://arxiv.org/abs/2604.18248)
...
### [48] [Subcodes of Lambda-Gabidulin Codes for Compact-Ciphertext Cryptography](https://arxiv.org/abs/2604.18282)
...
### [49] [Tight Auditing of Differential Privacy in MST and AIM](https://arxiv.org/abs/2604.18352)
...
### [50] [Capturing Monetarily Exploitable Vulnerability in Smart Contracts via Auditor Knowledge-Learning Fuzzing](https://arxiv.org/abs/2604.18395)
...
### [51] [Different Paths to Harmful Compliance: Behavioral Side Effects and Mechanistic Divergence Across LLM Jailbreaks](https://arxiv.org/abs/2604.18510)
...
### [52] [Do Privacy Policies Match with the Logs? An Empirical Study of Privacy Disclosure in Android Application Logs](https://arxiv.org/abs/2604.18552)
