...
### [9] [Perceptual Gaps: ASCII Art and Overlapping Audio as CAPTCHA](https://arxiv.org/abs/2604.03612)
...
### [10] [A Faceted Classification of Authenticator-Centric Authentication Techniques](https://arxiv.org/abs/2604.03627)
...
### [11] [Explainable PQC: A Layered Interpretive Framework for Post-Quantum Cryptographic Security Assumptions](https://arxiv.org/abs/2604.03665)
...
### [12] [CREBench: Evaluating Large Language Models in Cryptographic Binary Reverse Engineering](https://arxiv.org/abs/2604.03750)
...
### [13] [Spatiotemporal-Aware Bit-Flip Injection on DNN-based Advanced Driver Assistance Systems](https://arxiv.org/abs/2604.03753)
...
### [14] [Partial Number Theoretic Transform Masking in Post Quantum Cryptography Hardware: A Security Margin Analysis](https://arxiv.org/abs/2604.03813)
...
### [15] [Explainability-Guided Adversarial Attacks on Transformer-Based Malware Detectors Using Control Flow Graphs](https://arxiv.org/abs/2604.03843)
...
### [16] [Safety and Liveness of Cross-Domain State Preservation under Byzantine Faults: A Mechanized Proof in Isabelle/HOL](https://arxiv.org/abs/2604.03844)
*Jinwook Kim*
...
### [17] [Defending Buffer Overflows in WebAssembly: A Transpiler Approach](https://arxiv.org/abs/2604.03859)
*Weiqi Feng*
...
### [18] [LiquiLM: Bridging the Semantic Gap in Liquidity Flaw Audit via DCN and LLMs](https://arxiv.org/abs/2604.03860)
...
### [19] [SecureAFL: Secure Asynchronous Federated Learning](https://arxiv.org/abs/2604.03862)
...
### [20] [Graduated Trust Gating for IoT Location Verification: Trading Off Detection and Proof Escalation](https://arxiv.org/abs/2604.03896)
*Yoshiyuki Ootani*
...
### [21] [Context-Binding Gaps in Stateful Zero-Knowledge Proximity Proofs: Taxonomy, Separation, and Mitigation](https://arxiv.org/abs/2604.03900)
*Yoshiyuki Ootani*
...
### [25] [TraceGuard: Structured Multi-Dimensional Monitoring as a Collusion-Resistant Control Protocol](https://arxiv.org/abs/2604.03968)
...
### [26] [Assessing Cyber Risks in Hydropower Systems Through HAZOP and Bow-Tie Analysis](https://arxiv.org/abs/2604.03994)
...
### [27] [Enabling Deterministic User-Level Interrupts in Real-Time Processors via Hardware Extension](https://arxiv.org/abs/2604.04015)
...
### [28] [Jellyfish: Zero-Shot Federated Unlearning Scheme with Knowledge Disentanglement](https://arxiv.org/abs/2604.04030)
...
### [29] [Causality Laundering: Denial-Feedback Leakage in Tool-Calling LLM Agents](https://arxiv.org/abs/2604.04035)
...
### [30] [CoopGuard: Stateful Cooperative Agents Safeguarding LLMs Against Evolving Multi-Round Attacks](https://arxiv.org/abs/2604.04060)
...
### [31] [Styx: Collaborative and Private Data Processing With TEE-Enforced Sticky Policy](https://arxiv.org/abs/2604.04082)
...
### [32] [Invisible Adversaries: A Systematic Study of Session Manipulation Attacks on VPNs](https://arxiv.org/abs/2604.04099)
...
### [33] [Triggering and Detecting Exploitable Library Vulnerability from the Client by Directed Greybox Fuzzing](https://arxiv.org/abs/2604.04102)
...
### [34] [NetSecBed: A Container-Native Testbed for Reproducible Cybersecurity Experimentation](https://arxiv.org/abs/2604.04121)
...
### [35] [Beamforming Feedback as a Novel Attack Surface for Wi-Fi Physical-Layer Security](https://arxiv.org/abs/2604.04179)
...
### [36] [Merkle Tree Certificate Post-Quantum PKI for Kubernetes and Cloud-Native 5G/B5G Core](https://arxiv.org/abs/2604.04191)
...
### [37] [Perils of Parallelism: Transaction Fee Mechanisms under Execution Uncertainty](https://arxiv.org/abs/2604.04193)
...
### [38] [LOCARD: An Agentic Framework for Blockchain Forensics](https://arxiv.org/abs/2604.04211)
...
### [40] [Semantics Over Syntax: Uncovering Pre-Authentication 5G Baseband Vulnerabilities](https://arxiv.org/abs/2604.04283)
...
### [41] [LLM-Enabled Open-Source Systems in the Wild: An Empirical Study of Vulnerabilities in GitHub Security Advisories](https://arxiv.org/abs/2604.04288)
...
### [42] [Poisoned Identifiers Survive LLM Deobfuscation: A Case Study on Claude Opus 4.6](https://arxiv.org/abs/2604.04289)
*Luis Guzmán Lorenzo*
...
### [43] [Evaluating Future Air Traffic Management Security](https://arxiv.org/abs/2604.04293)
*Konstantinos Spalas*
...
### [44] [DAO to (Anonymous) DAO Transactions](https://arxiv.org/abs/2604.04369)
...
### [45] [Explainable Autonomous Cyber Defense using Adversarial Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2604.04442)
...
### [46] [Mapping the Exploitation Surface: A 10,000-Trial Taxonomy of What Makes LLM Agents Exploit Vulnerabilities](https://arxiv.org/abs/2604.04561)
...
### [47] [Digital Privacy in IoT: Exploring Challenges, Approaches and Open Issues](https://arxiv.org/abs/2604.04572)
...
### [48] [Packing Entries to Diagonals for Homomorphic Sparse-Matrix Vector Multiplication](https://arxiv.org/abs/2604.04683)
...
### [49] [GPIR: Enabling Practical Private Information Retrieval with GPUs](https://arxiv.org/abs/2604.04696)
...
### [50] [Bridging Safety and Security in Complex Systems: A Model-Based Approach with SAFT-GT Toolchain](https://arxiv.org/abs/2604.04705)
...
### [51] [Hardware-Level Governance of AI Compute: A Feasibility Taxonomy for Regulatory Compliance and Treaty Verification](https://arxiv.org/abs/2604.04712)
*Samar Ansari*
...
### [52] [Economic Security of VDF-Based Randomness Beacons: Models, Thresholds, and Design Guidelines](https://arxiv.org/abs/2604.04744)
...
### [53] [RegGuard: Legitimacy and Fairness Enforcement for Optimistic Rollups](https://arxiv.org/abs/2604.04748)
...
### [54] [Undetectable Conversations Between AI Agents via Pseudorandom Noise-Resilient Key Exchange](https://arxiv.org/abs/2604.04757)
...
### [55] [Your Agent, Their Asset: A Real-World Safety Analysis of OpenClaw](https://arxiv.org/abs/2604.04759)
...
### [56] [GPU Acceleration of TFHE-Based High-Precision Nonlinear Layers for Encrypted LLM Inference](https://arxiv.org/abs/2604.04783)
...
### [57] [Unpacking .zip: A First Look at Domain and File Name Confusion](https://arxiv.org/abs/2604.04805)
...
### [58] [Cryptanalysis of the Legendre Pseudorandom Function over Extension Fields](https://arxiv.org/abs/2604.04833)
*Daksh Pandey*
...
### [59] [Strengthening Human-Centric Chain-of-Thought Reasoning Integrity in LLMs via a Structured Prompt Framework](https://arxiv.org/abs/2604.04852)
...
### [60] [Comprehensive List of User Deception Techniques in Emails](https://arxiv.org/abs/2604.04926)
