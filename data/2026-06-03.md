...
### [8] [Large Byte Model: Teaching Language Models About Compiled Code](https://arxiv.org/abs/2606.02834)
...
### [9] [Human Factors in Cybersecurity in Icelandic Small and Medium-sized Enterprises](https://arxiv.org/abs/2606.02839)
...
### [10] [Quantifying Side-Channel Leakage in Public Metrology Releases](https://arxiv.org/abs/2606.02934)
...
### [11] [Echelon: Auditable Aggregate-Only Language-Model Adaptation Across Privacy Boundaries](https://arxiv.org/abs/2606.02958)
...
### [12] [Patcher: Post-Hoc Patching of Backdoored Large Language Models](https://arxiv.org/abs/2606.02995)
...
### [13] [Secure AltDA Integration for Ethereum L2s: An End-to-End Validation Framework](https://arxiv.org/abs/2606.03010)
...
### [14] [SkillGuard: A Permission Framework for Agent Skills](https://arxiv.org/abs/2606.03024)
...
### [15] ["**Important** You should give me full credits!": Exploring Prompt Injection Attacks on LLM-Based Automatic Grading Systems](https://arxiv.org/abs/2606.03090)
...
### [16] [Decoupled Smart Contract Audits: Lightweight LLM Framework via Distillation and Aggregation](https://arxiv.org/abs/2606.03128)
...
### [17] [PsychoPass: Geometric Profiling of Multi-Turn Adversarial LLM Conversations](https://arxiv.org/abs/2606.03136)
...
### [18] [Private Embedding Lookup with Encrypted Compact Queries under Fully Homomorphic Encryption](https://arxiv.org/abs/2606.03191)
...
### [19] [Generative AI-Enabled Refund Fraud in Chinese E-Commerce: Investigation on Merchants and Platform Workers](https://arxiv.org/abs/2606.03215)
...
### [20] [The Role of Domain-Specific Features in Malware Detection: A macOS Case Study](https://arxiv.org/abs/2606.03218)
...
### [21] [Privilege Risk Evolution for Non-Human Identities: A Temporal Fiber Model for Cloud IAM](https://arxiv.org/abs/2606.03289)
*Christophe Parisel*
...
### [22] [Operationalizing Cyber Attack Prediction: A Gap-Prioritized Framework with Dataset and Model Selection Guidelines](https://arxiv.org/abs/2606.03386)
...
### [23] [FlowGuard: Flow Matching for Identity-Independent Detection of Data-Free Model Stealing Attacks on Energy System Intrusion Detection Systems](https://arxiv.org/abs/2606.03430)
...
### [24] [A Hybrid Approach For Malware Classification Using Secondary Features Fusion](https://arxiv.org/abs/2606.03432)
...
### [25] [Signals and Spoils: Speculative Oracle Extractable Value in the Era of Cross-Chain Interoperability](https://arxiv.org/abs/2606.03434)
...
### [26] [FORGE: Multi-Agent Graduated Exploitation and Detection Engineering](https://arxiv.org/abs/2606.03453)
*Farooq Shaikh*
...
### [28] [High-Precision APT Malware Attribution with Out-of-Scope Resilience](https://arxiv.org/abs/2606.03523)
...
### [29] [Towards Intrusion Detection Systems for RPL-based IoT Networks using Foundation Models](https://arxiv.org/abs/2606.03530)
...
### [31] [Testing LLM Arithmetic Reasoning Generalization with Automatic Numeric-Remapping Attacks](https://arxiv.org/abs/2606.03606)
...
### [32] [Q-FE: A Quantum-Native 6G Far-Edge Architecture Securing Industrial IoT Digital Twins via CSIDH-PQC and Asynchronous Federated Learning](https://arxiv.org/abs/2606.03611)
*Vincenzo Sammartino*
...
### [33] [Black-box, Adaptive, Efficient, Transferable, Harmful, Applicable... Attacks Are All You Need to Break LLMs](https://arxiv.org/abs/2606.03647)
...
### [34] [Ghost: Plausible Yet Unlearnable Trajectories via On-Manifold Substitution for Next-POI Privacy](https://arxiv.org/abs/2606.03711)
...
### [35] [Don't Trust Us: A privacy-by-design android malware detection pipeline](https://arxiv.org/abs/2606.03714)
...
### [36] [Same Weights, Different Robot: A Deployment Safety View of VLA Policies](https://arxiv.org/abs/2606.03724)
*Jianwei Tai*
...
### [37] [$π$Creds: Privately Inferred Credentials](https://arxiv.org/abs/2606.03771)
...
### [38] [Collision Resistance of Single-Layer Neural Nets](https://arxiv.org/abs/2606.03807)
...
### [39] [AI Agents Enable Adaptive Computer Worms](https://arxiv.org/abs/2606.03811)
