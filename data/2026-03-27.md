...
### [1] [An Explainable Federated Framework for Zero Trust Micro-Segmentation in IIoT Networks](https://arxiv.org/abs/2603.24754)
...
### [2] [AIP: Agent Identity Protocol for Verifiable Delegation Across MCP and A2A](https://arxiv.org/abs/2603.24775)
*Sunil Prakash*
...
### [3] [Bridging Code Property Graphs and Language Models for Program Analysis](https://arxiv.org/abs/2603.24837)
*Ahmed Lekssays*
...
### [4] [Sovereign AI at the Front Door of Care: A Physically Unidirectional Architecture for Secure Clinical Intelligence](https://arxiv.org/abs/2603.24898)
...
### [5] [LiteGuard: Efficient Task-Agnostic Model Fingerprinting with Enhanced Generalization](https://arxiv.org/abs/2603.24982)
...
### [6] [IrisFP: Adversarial-Example-based Model Fingerprinting with Enhanced Uniqueness and Robustness](https://arxiv.org/abs/2603.24996)
...
### [7] [Efficient ML-DSA Public Key Management Method with Identity for PKI and Its Application](https://arxiv.org/abs/2603.25043)
...
### [8] [zk-X509: Privacy-Preserving On-Chain Identity from Legacy PKI via Zero-Knowledge Proofs](https://arxiv.org/abs/2603.25190)
*Yeongju Bak*
