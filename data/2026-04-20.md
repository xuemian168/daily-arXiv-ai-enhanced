...
### [12] [Privacy, Prediction, and Allocation](https://arxiv.org/abs/2604.15596)
...
### [13] [Too Private to Tell: Practical Token Theft Attacks on Apple Intelligence](https://arxiv.org/abs/2604.15637)
...
### [14] [Half-Moon Cookie: Private, Similarity-Based Blocklisting with TOCTOU-Attack Resilience](https://arxiv.org/abs/2604.15641)
...
### [15] [DPDSyn: Improving Differentially Private Dataset Synthesis for Model Training by Downstream Task Guidance](https://arxiv.org/abs/2604.15660)
...
### [16] [DEMUX: Boundary-Aware Multi-Scale Traffic Demixing for Multi-Tab Website Fingerprinting](https://arxiv.org/abs/2604.15677)
...
### [17] [Into the Gray Zone: Domain Contexts Can Blur LLM Safety Boundaries](https://arxiv.org/abs/2604.15717)
...
### [18] [Privacy-Preserving LLMs Routing](https://arxiv.org/abs/2604.15728)
...
### [19] [Secure Authentication in Wireless IoT: Hamming Code Assisted SRAM PUF as Device Fingerprint](https://arxiv.org/abs/2604.15810)
...
### [20] [A Protocol-Agnostic Backscatter-Based Security Layer for Ultra-Low-Power SWIPT IoT Networks](https://arxiv.org/abs/2604.15831)
...
### [21] [QUACK! Making the (Rubber) Ducky Talk: A Systematic Study of Keystroke Dynamics for HID Injection Detection](https://arxiv.org/abs/2604.15845)
...
### [22] [Module Lattice Security (Part I): Unconditional Verification of Weber's Conjecture for $k \le 12$](https://arxiv.org/abs/2604.15858)
*Ming-Xing Luo*
...
### [23] [Low-Stack HAETAE for Memory-Constrained Microcontrollers](https://arxiv.org/abs/2604.15868)
...
### [24] [A Case Study on the Impact of Anonymization Along the RAG Pipeline](https://arxiv.org/abs/2604.15958)
...
### [25] [TwoHamsters: Benchmarking Multi-Concept Compositional Unsafety in Text-to-Image Models](https://arxiv.org/abs/2604.15967)
...
### [26] [Where Does MEV Really Come From? Revisiting CEXDEX Arbitrage on Ethereum](https://arxiv.org/abs/2604.15973)
...
### [27] [MATRIX: Multi-Layer Code Watermarking via Dual-Channel Constrained Parity-Check Encoding](https://arxiv.org/abs/2604.16001)
...
### [28] [Modeling Sparse and Bursty Vulnerability Sightings: Forecasting Under Data Constraints](https://arxiv.org/abs/2604.16038)
...
### [29] [ProcRoute: Process-Scoped Authorization of Split-Tunnel Routes](https://arxiv.org/abs/2604.16080)
...
### [30] [PolicyGapper: Automated Detection of Inconsistencies Between Google Play Data Safety Sections and Privacy Policies Using LLMs](https://arxiv.org/abs/2604.16128)
